			...
			when: {
				...
				turned: function(e, page) {
					...
					if ( page < $(this).turn('pages') ) {
						...
						if(page1>2&&page1<Book_v7.getLength()){
						   ...
						   if(RTL=="true"){
						   	  var page_view=Math.max(page2-2,page1-2)+"-"+Math.min(page2-2,page1-2);  
						   }else{
							  var page_view=Math.min(page2-2,page1-2)+"-"+Math.max(page2-2,page1-2);   
						   }
						}else{
						  var page_view=page1>= 2 ? page1-1:'';						
						}
